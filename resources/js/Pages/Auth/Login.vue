    ...
    <div class="w-full max-w-sm space-y-8">
        ...
        <div>
          ...
          <div class="mt-2">
            <input v-model="form.email" required autofocus id="email" name="email" type="email" autocomplete="email"
              class="block w-full px-3 py-2 border-gray-300 rounded-md shadow-sm focus:border-lime-500 focus:ring-lime-500 sm:text-sm">
          </div>
      ...
      <p class="mt-10 text-sm text-center text-gray-500">
        ...
        <Link :href="route('register')"
          class="text-sm text-gray-600 underline rounded-md hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-lime-500 focus:ring-offset-2">
           Cadastre-se
        </Link>
      </p>
    </div>
